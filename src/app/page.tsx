...
const featuredProducts = [
  ...
  { id: 4, name: "Laptop Backpack", price: 49.99, image: "/placeholder.svg?height=200&width=200" },
]
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg p-8 mb-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl mb-6">Discover the latest gadgets and accessories for your digital lifestyle.</p>
          <Button asChild size="lg" className="bg-white text-purple-600 hover:bg-gray-100">
            <Link href="/products">Shop Now <ShoppingCart className="ml-2 h-5 w-5" /></Link>
          </Button>
        </div>
      </section>
      ...
      <section className="bg-gray-100 rounded-lg p-8 text-center">
        ...
        <p className="text-xl mb-6">Stay updated with our latest products and exclusive offers!</p>
